...
namespace ResourceManager.Core
{
    public class VSFileContainer
    {
        ...
        {
            string path = Path.Combine(Project.Solution.SolutionDirectory.FullName, filepath);
            FileInfo[] files;
            bool isValid = false;
            ...
            try
            {
                directory.GetFiles("*.resx", SearchOption.TopDirectoryOnly);
                isValid = true;
            }
            catch
            {
            ...
            files = directory.GetFiles("*.resx", SearchOption.TopDirectoryOnly);
